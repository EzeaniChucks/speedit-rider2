    ...
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        <Text style={styles.instruction}>
          Profile picture: upload your best photo (selfies are welcome). Take
          the photo in a bright area, avoiding reflections and blurry images.
        </Text>
      </View>
      <Button
        style={styles.button}
        ...
        color="green"
      />
      {isBottomSheetOpen && <UploadBottomSheet onChoose={() => handleNext()} />}
    </View>
  );
};
